...
import static com.mithun.auth.jwt.JWTConstants.EXPIRATION_TIME;
import static com.mithun.auth.jwt.JWTConstants.KEY;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            RestUser applicationUser = new ObjectMapper().readValue(req.getInputStream(), RestUser.class);
